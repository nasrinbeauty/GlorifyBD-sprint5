...
<div class="form-group">
    ...
    <div class="form-group">
      ...
      <textarea name="product_short_description" id="" cols="30" rows="3" class="form-control"><?php echo $short_desc; ?></textarea>
    </div>
    ...
    <div class="form-group">
         ...
         <select name="product_category_id" id="" class="form-control">
           ...
           categories_length();
            ...
            <option value="1"><?php echo show_product_category_title(1); ?></option>
            <option value="2"><?php echo show_product_category_title(2); ?></option>
            <option value="3"><?php echo show_product_category_title(3); ?></option> -->
